...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContractManagement.Domain.Entity.Estoques.Estoque", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EstoquePedido", (string)null);
                });

            modelBuilder.Entity("ContractManagement.Domain.Entity.Estoques.ItemNotaEntrada", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("nota_entrada_id")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("nota_entrada_id");

                    b.ToTable("ItemNotaEntrada", (string)null);
                });

            modelBuilder.Entity("ContractManagement.Domain.Entity.Estoques.NotaEntrada", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ContractManagement.Domain.Entity.Estoques.ItemNotaEntrada", b =>
                {
                    b.HasOne("ContractManagement.Domain.Entity.Estoques.NotaEntrada", null)
                        .WithMany("Itens")
